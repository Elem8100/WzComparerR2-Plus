namespace WzComparerR2
{
    partial class FrmPatcher
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.superTooltip1.SetSuperTooltip(this.chkDeadPatch, new DevComponents.DotNetBar.SuperTooltipInfo("DeathPatch", "", "開啟此項後，每更新完一個子文件，將立即覆蓋原文件並刪除臨時文件。這樣做會減少臨時文件空間的需要，但是伴隨一定風險。", null, null, DevComponents.DotNetBar.eTooltipColor.System, true, false, new System.Drawing.Size(180, 100)));
            ...
            this.superTooltip1.SetSuperTooltip(this.chkPrePatch, new DevComponents.DotNetBar.SuperTooltipInfo("PrePatch", "", "開啟此項則會在補丁更新前進行預加載。預加載後可以自由選擇要更新的子文件，或調整子文件更新順序。調整完畢後再次單擊\"Patch\"按鈕開始更新。。", null, null, DevComponents.DotNetBar.eTooltipColor.Default, true, false, new System.Drawing.Size(180, 120)));
            ...
            this.superTooltip1.SetSuperTooltip(this.chkOutputRemovedImg, new DevComponents.DotNetBar.SuperTooltipInfo("OutputRemovedImg", "", "對比報告中是否輸出被整體移除的Image的完整結構\"Patch\"按鈕開始更新。", null, null, DevComponents.DotNetBar.eTooltipColor.System, true, false, new System.Drawing.Size(180, 60)));
            ...
            this.superTooltip1.SetSuperTooltip(this.chkOutputAddedImg, new DevComponents.DotNetBar.SuperTooltipInfo("OutputAddedImg", "", "對比報告中是否輸出新增Image的完整結構", null, null, DevComponents.DotNetBar.eTooltipColor.System, true, false, new System.Drawing.Size(180, 60)));
            ...
            this.superTooltip1.SetSuperTooltip(this.cmbComparePng, new DevComponents.DotNetBar.SuperTooltipInfo("PngComparison", "", "對於對比報告中圖片的對比方式。\r\nSizeOnly - 僅對比圖片大小，可能會遺漏。\r\nSizeAndDataLength - 同時對比圖片大小和壓縮流長度，可能" +
            "會誤判。\r\nPixel - 像素級對比，非常精確但可能略耗時。", null, null, DevComponents.DotNetBar.eTooltipColor.System, true, true, new System.Drawing.Size(300, 100)));
            ...
            this.superTooltip1.SetSuperTooltip(this.chkOutputPng, new DevComponents.DotNetBar.SuperTooltipInfo("OutputPng", "", "對比報告中是否輸出有差異的圖片文件。", null, null, DevComponents.DotNetBar.eTooltipColor.System, true, false, new System.Drawing.Size(180, 60)));
            ...
            this.superTooltip1.SetSuperTooltip(this.chkCompare, new DevComponents.DotNetBar.SuperTooltipInfo("Compare", "", "開啟此項後，每更新完一個Wz文件，將會進行新舊文件對比並輸出更新報告。有一些額外的選項可以控制對比更新的執行方式。\r\n對比過程出錯不會影響補丁繼續執行。", null, null, DevComponents.DotNetBar.eTooltipColor.System, true, false, new System.Drawing.Size(238, 100)));
            ...
            this.labelX3.Text = "這功能太危險了在考慮要不要放出來...還是算了吧";
            // 
            // superTooltip1
            // 
            ...
            this.superTooltip1.SetSuperTooltip(this.chkResolvePngLink, new DevComponents.DotNetBar.SuperTooltipInfo("ResolvePngLink", "", "對比報告中是否智能解析對比被Link的圖片\r\n這會過濾掉無用的變更內容", null, null, DevComponents.DotNetBar.eTooltipColor.System, true, false, new System.Drawing.Size(180, 72)));
